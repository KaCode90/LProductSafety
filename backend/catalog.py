...
module('test-plan','Kế hoạch kiểm nghiệm','materials',fields([('material_name','Tên Thành phẩm','text',None,True),('material_code','Mã thành phẩm (Part Code)'),('test_type','Loại test'),('test','Loại test mẫu (bên thứ 3)'),('category','Category'),('report_deadline','Thời hạn báo cáo','date'),('report_result','Kết quả báo cáo','select',['Pending','Pass','Fail','NG','Khác'])]))
