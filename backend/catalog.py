...
module('xrf-plan','XRF plan','xrf-group',fields([('test','Test','text',None,True),('category','Category'),('npi_phase','NPI Phase'),('mp_phase','MP phase')]))
